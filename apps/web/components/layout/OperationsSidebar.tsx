          ...
          <a
            className={
              item.href === activeHref
                ? 'rounded-lg bg-[#17211f] px-3 py-2.5 text-sm font-bold text-white'
                : 'rounded-lg px-3 py-2.5 text-sm font-semibold text-[#68736f] transition-colors hover:bg-white hover:text-[#17211f]'
            }
            href={item.href}
            key={item.href}
          >
