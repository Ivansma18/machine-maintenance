        ...
        <div className="min-w-0 flex-1">
          ...
          <main className="px-5 py-7 sm:px-8 sm:py-9 lg:px-10 lg:py-12">
            ...
            <AppPanel
              ...
              eyebrow="Encuentra una señal operativa"
            >
              <NotificationFilters
            ...
            {notifications.meta.totalPages > 1 ? (
              <div className="mt-5 flex items-center justify-end gap-3">
                <AppButton
                  ...
                  onClick={() =>
                    notifications.updateFilters({ page: notifications.filters.page - 1 })
                  }
                >
                  Anterior
                </AppButton>
